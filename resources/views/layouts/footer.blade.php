            ...
            <div class="flex flex-col items-center md:items-start space-y-3 text-center md:text-left">
                ...
                <div class="w-full mt-2">
                    <div class="flex justify-center md:justify-start space-x-4">
                        ...
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/ChancesPlatform" target="_blank" class="text-white hover:text-blue-500 transition">
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/company/chancesplatform" target="_blank" class="text-white hover:text-blue-400 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
                        ...
                        <!-- Twitter / X -->
                        <a href="https://twitter.com/ChancesPlatform" target="_blank" class="text-white hover:text-gray-400 transition">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/chances_platform" target="_blank" class="text-white hover:text-blue-400 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
                        ...
                        <!-- Telegram -->
                        <a href="https://t.me/ChancesPlatform" target="_blank" class="text-white hover:text-blue-400 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
