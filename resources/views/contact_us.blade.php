        ...
        <form class="bg-blue-50 shadow-md rounded-lg p-8 max-w-3xl w-full" method="post" action="{{ route('contact.store') }}">
            ...
            <div class="mb-4 flex space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <input type="number" id="phone" name="phone" value="{{ old('phone') }}" required class="mt-1 p-2 border border-gray-300 rounded w-full" placeholder="{{ __('Your Phone Number') }}">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <select id="type" name="type" required class="mt-1 p-2 border border-gray-300 rounded w-full">
                    ...
                    <option value="Other" {{ old('other') == 'Other' ? 'selected' : '' }}>{{ __('Others') }}</option>
                </select>
            </div>
