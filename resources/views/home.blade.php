        ...
        <section class="flex flex-col items-center justify-center h-[20rem] text-white">
            ...
            <section>
                <form class="flex justify-center mt-3 bg-white p-2 rounded-3xl">
                    ...
                    <button type="submit" class=" relative right-2 text-white bg-primary-color hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-sm w-10 h-10 flex items-center justify-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        <!-- Search Icon -->
